            ...
            <div class="box-header with-border">
              <div align="right" style="float: right;"><br>
                ...
                <div class="input-group">
                  ...
                  <iframe src="print_pay.php" style="display:none;" name="frame_dtr"></iframe>
                  <button class="btn btn-success btn-flat" name="print_payroll" onclick="frames['frame_dtr'].print()"><i class="fa fa-print"></i> DTR</button> &nbsp;
                  <iframe src="print_payslip.php" style="display:none;" name="frame_payslip"></iframe>
                  <button class="btn btn-primary btn-flat" name="print_payslip" onclick="frames['frame_payslip'].print()"><i class="fa fa-print"></i> Payslip</button>
                </div>
                </form>
              </div>
            </div>
